...
C     
C     Process: e+ e- > e+ e- ta+ ta- WEIGHTED<=8 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_4_3(W(1,3),W(1,4),-GC_51,GC_59,MDL_MZ, FK_MDL_WZ,W(1
     $ ,11))
C     Amplitude(s) for diagram number 3
      CALL FFV2_4_0(W(1,9),W(1,6),W(1,11),-GC_51,GC_59,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV2_4_0(W(1,5),W(1,10),W(1,11),-GC_51,GC_59,AMP(4))
      CALL FFV2_4_3(W(1,2),W(1,1),-GC_51,GC_59,MDL_MZ, FK_MDL_WZ,W(1
     $ ,10))
      CALL FFV2_4_2(W(1,5),W(1,10),-GC_51,GC_59,MDL_MTA, FK_ZERO,W(1,9)
     $ )
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,9),W(1,6),W(1,8),GC_3,AMP(5))
      CALL FFV2_4_1(W(1,6),W(1,10),-GC_51,GC_59,MDL_MTA, FK_ZERO,W(1
     $ ,12))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,5),W(1,12),W(1,8),GC_3,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV2_4_0(W(1,9),W(1,6),W(1,11),-GC_51,GC_59,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_4_0(W(1,5),W(1,12),W(1,11),-GC_51,GC_59,AMP(8))
      CALL FFS4_3(W(1,5),W(1,6),GC_99,MDL_MH, FK_MDL_WH,W(1,12))
C     Amplitude(s) for diagram number 9
      CALL VVS1_0(W(1,10),W(1,11),W(1,12),GC_81,AMP(9))
      CALL FFV1P0_3(W(1,5),W(1,6),GC_3,ZERO, FK_ZERO,W(1,9))
      CALL FFV1_2(W(1,3),W(1,7),GC_3,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,13),W(1,4),W(1,9),GC_3,AMP(10))
      CALL FFV1_1(W(1,4),W(1,7),GC_3,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,3),W(1,14),W(1,9),GC_3,AMP(11))
      CALL FFV2_4_3(W(1,5),W(1,6),-GC_51,GC_59,MDL_MZ, FK_MDL_WZ,W(1,7)
     $ )
C     Amplitude(s) for diagram number 12
      CALL FFV2_4_0(W(1,13),W(1,4),W(1,7),-GC_51,GC_59,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV2_4_0(W(1,3),W(1,14),W(1,7),-GC_51,GC_59,AMP(13))
      CALL FFV2_4_2(W(1,3),W(1,10),-GC_51,GC_59,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,14),W(1,4),W(1,9),GC_3,AMP(14))
      CALL FFV2_4_1(W(1,4),W(1,10),-GC_51,GC_59,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,3),W(1,13),W(1,9),GC_3,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_4_0(W(1,14),W(1,4),W(1,7),-GC_51,GC_59,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV2_4_0(W(1,3),W(1,13),W(1,7),-GC_51,GC_59,AMP(17))
      CALL FFV1P0_3(W(1,3),W(1,1),GC_3,ZERO, FK_ZERO,W(1,13))
      CALL FFV1P0_3(W(1,2),W(1,4),GC_3,ZERO, FK_ZERO,W(1,14))
      CALL FFV1_2(W(1,5),W(1,13),GC_3,MDL_MTA, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,10),W(1,6),W(1,14),GC_3,AMP(18))
      CALL FFV1_1(W(1,6),W(1,13),GC_3,MDL_MTA, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,5),W(1,15),W(1,14),GC_3,AMP(19))
      CALL FFV2_4_3(W(1,2),W(1,4),-GC_51,GC_59,MDL_MZ, FK_MDL_WZ,W(1
     $ ,16))
C     Amplitude(s) for diagram number 20
      CALL FFV2_4_0(W(1,10),W(1,6),W(1,16),-GC_51,GC_59,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_4_0(W(1,5),W(1,15),W(1,16),-GC_51,GC_59,AMP(21))
      CALL FFV2_4_3(W(1,3),W(1,1),-GC_51,GC_59,MDL_MZ, FK_MDL_WZ,W(1
     $ ,15))
      CALL FFV2_4_2(W(1,5),W(1,15),-GC_51,GC_59,MDL_MTA, FK_ZERO,W(1
     $ ,10))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,10),W(1,6),W(1,14),GC_3,AMP(22))
      CALL FFV2_4_1(W(1,6),W(1,15),-GC_51,GC_59,MDL_MTA, FK_ZERO,W(1
     $ ,17))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,5),W(1,17),W(1,14),GC_3,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV2_4_0(W(1,10),W(1,6),W(1,16),-GC_51,GC_59,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL FFV2_4_0(W(1,5),W(1,17),W(1,16),-GC_51,GC_59,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL VVS1_0(W(1,15),W(1,16),W(1,12),GC_81,AMP(26))
      CALL FFV1_2(W(1,2),W(1,13),GC_3,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,12),W(1,4),W(1,9),GC_3,AMP(27))
      CALL FFV1_1(W(1,4),W(1,13),GC_3,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,2),W(1,17),W(1,9),GC_3,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV2_4_0(W(1,12),W(1,4),W(1,7),-GC_51,GC_59,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV2_4_0(W(1,2),W(1,17),W(1,7),-GC_51,GC_59,AMP(30))
      CALL FFV2_4_2(W(1,2),W(1,15),-GC_51,GC_59,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,17),W(1,4),W(1,9),GC_3,AMP(31))
      CALL FFV2_4_1(W(1,4),W(1,15),-GC_51,GC_59,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,2),W(1,12),W(1,9),GC_3,AMP(32))
C     Amplitude(s) for diagram number 33
      CALL FFV2_4_0(W(1,17),W(1,4),W(1,7),-GC_51,GC_59,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFV2_4_0(W(1,2),W(1,12),W(1,7),-GC_51,GC_59,AMP(34))
      CALL FFV1_1(W(1,1),W(1,14),GC_3,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,3),W(1,12),W(1,9),GC_3,AMP(35))
      CALL FFV1_1(W(1,1),W(1,9),GC_3,ZERO, FK_ZERO,W(1,17))
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,3),W(1,17),W(1,14),GC_3,AMP(36))
C     Amplitude(s) for diagram number 37
      CALL FFV2_4_0(W(1,3),W(1,12),W(1,7),-GC_51,GC_59,AMP(37))
      CALL FFV2_4_1(W(1,1),W(1,7),-GC_51,GC_59,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,3),W(1,12),W(1,14),GC_3,AMP(38))
      CALL FFV2_4_1(W(1,1),W(1,16),-GC_51,GC_59,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,3),W(1,14),W(1,9),GC_3,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV2_4_0(W(1,3),W(1,17),W(1,16),-GC_51,GC_59,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL FFV2_4_0(W(1,3),W(1,14),W(1,7),-GC_51,GC_59,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV2_4_0(W(1,3),W(1,12),W(1,16),-GC_51,GC_59,AMP(42))
      CALL FFV1_1(W(1,1),W(1,8),GC_3,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,2),W(1,16),W(1,9),GC_3,AMP(43))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,2),W(1,17),W(1,8),GC_3,AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFV2_4_0(W(1,2),W(1,16),W(1,7),-GC_51,GC_59,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL FFV1_0(W(1,2),W(1,12),W(1,8),GC_3,AMP(46))
      CALL FFV2_4_1(W(1,1),W(1,11),-GC_51,GC_59,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 47
      CALL FFV1_0(W(1,2),W(1,8),W(1,9),GC_3,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV2_4_0(W(1,2),W(1,17),W(1,11),-GC_51,GC_59,AMP(48))
C     Amplitude(s) for diagram number 49
      CALL FFV2_4_0(W(1,2),W(1,8),W(1,7),-GC_51,GC_59,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFV2_4_0(W(1,2),W(1,12),W(1,11),-GC_51,GC_59,AMP(50))
